...
const LoginForm = () => {
  ...
  return (
    <div>
      ...
      <p className="auth-subtitle">Sign in to your curated collection.</p>
        ...
        <div className="auth-field">
          ...
          {authMethod === "email" ? (
            <input
              ...
              placeholder="identity@aurelian.com"
              required
      ...
      <button type="button" onClick={handleGoogleLogin} disabled={googleLoading} className="auth-google-btn">
        <GoogleIcon />
        {googleLoading ? "Signing in…" : "Continue with Google"}
      </button>

      <p className="auth-footer-note">
        New to Aurelian? <Link to="/signup">Create an account</Link>
      </p>
    </div>
  );
};
